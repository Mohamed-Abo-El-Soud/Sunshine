...
import com.example.ahmedabdalla.sunshine.app.data.WeatherDBHelper;
...
public class TestProvider extends AndroidTestCase{
    ...
    public void testInsertReadProvider() {
        ...
        long locationRowId;
        Uri insertLocationUri = mContext.getContentResolver().insert(LocationEntry.CONTENT_URI
                , testValues);
        ...
        Cursor cursor = mContext.getContentResolver().query(
                LocationEntry.buildLocationUri(locationRowId),//.CONTENT_URI,
                null,
                null,
                null,
                null);
        ...
        Uri insertWeatherUri = mContext.getContentResolver().insert(WeatherEntry.CONTENT_URI
                , weatherValues);
        ...
        // Get the joined Weather and Location data with date
        weatherCursor = mContext.getContentResolver().query(
